...
local function r22_0(r0_33, r1_33)
	...
	local r6_33 = "SwimA()AIO()/ Owner Verse"
	local r7_33 = ""
	local r8_33 = nil
	if r1_33 then
...
r39_0.FriendlyPlayerEnabled = false
	...
	r41_0 = {
		...
		Mlg = "rbxassetid://118542203594783",
	}
	...
	task.spawn(function()
		...
		local r52_56 = r14_56.element("Toggle", "Randomize Aim Part - Silent, Instant Hit", false, function(r0_80)
			-- line: [0, 0] id: 80
			r39_0.AimbotRandomizeHitPart = r0_80.Toggle
		end)
		local r53_56 = r14_56.element("Toggle", "Target Nearest Aim Part", false, function(r0_189)
			-- line: [0, 0] id: 189
			if r39_0.AimbotRandomizeHitPart then
			end
			r39_0.AimbotNearestPartToCursor = r0_189.Toggle
		end)
...
friendlyToggle:add_keybind("Hold", function(r0)
    ...
    r27_0.UpdateKeybinds("Friendly Player", r0.Key, r39_0.FriendlyPlayerEnabled, r39_0.FriendlyPlayer ~= nil)
		...
		r24_56.element("Toggle", "Peek Kill - Risky", false, function(r0_176)
			-- line: [0, 0] id: 176
	...
	function r122_0()
		...
		if false then --not r11_0:FindFirstChild(r37_0) then
			...
			if r39_0.UPAngleChanger and r0_273 then
				--r39_0.UPAngleValue = math.random(-160, 160)
				--print(r39_0.UPAngleValue)
					...
					if r4_273 and r4_273.Item:FindFirstChild("Offsets") then
						...
						if r5_273 and r6_273 then
							...
							if r8_273 <= r7_273 then
								...
								r8_273 = r116_0:InvokeServer(Vector3.new(0 / 0, 0 / 0, 0 / 0), r7_273, r117_0)
								if r8_273 then
									task.spawn(function()
										-- line: [0, 0] id: 274
										r115_0:FireServer(r6_273, r6_273.CFrame:ToObjectSpace(CFrame.new(r6_273.Position + Vector3.new(0, 1, 0) * 0.01)), r7_273, 0 / 0)
									end)
								end
								-- close: r7_273
							end
							...
							if r8_273 and r8_273.Item:FindFirstChild("Offsets") then
								...
								if r9_273 and r10_273 then
									...
									if r39_0.InstantHitDelay <= r11_273 then
										...
										if r116_0:InvokeServer(Vector3.new(0 / 0, 0 / 0, 0 / 0), r11_273, r117_0) then
											task.spawn(function()
												-- line: [0, 0] id: 277
												r115_0:FireServer(r10_273, r10_273.CFrame:ToObjectSpace(CFrame.new(r10_273.Position + Vector3.new(0, 1, 0) * 0.01)), r11_273, 0 / 0)
											end)
										end
										-- close: r11_273
									end
